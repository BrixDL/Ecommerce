...
{{('')}}
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Tinder Kick's</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright Tinder Kick's by
          <a class="text-primary" href="http://127.0.0.1:8000/" target="_blank">Brix</a>.
        </p>
      </div>
    </div>
</body>
